...
# 1. СҮҮЛИЙН ҮЕИЙН ТОХИРГОО (ЭНЭ ХЭСЭГ ХАМГИЙН ДЭЭД ТАЛД БАЙХ ЁСТОЙ)
...
if st.session_state.selected_menu == "Нүүр хуудас":
    ...
    with col2:
        st.markdown(f"""<div class="goal-box"><div class="main-header">Бидний зорилго</div>
            ...
            өөрийн мэдлэг чадвараа бие даан ахиулж, ирээдүйн амжилтынхаа эхлэлийг өнөөдөр тавьцгаая!
