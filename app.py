...
if selected == "Нүүр хуудас":
    ...
    with st.form("math_test_form"):
        ...
        # 1-р асуулт
        st.write("1. Тэгш өнцөгт △ABC-ийн ∠C=90° бол sinA харьцааг нэрлэнэ үү?")
        st.latex(r"\sin A = \frac{\text{эсрэг катет}}{\text{гипотенуз}}")
        q1 = st.radio("Хариулт:", ["AC/AB", "BC/AB", "BC/AC", "AC/BC"], index=None, key="q1")
        
        q2 = st.radio("2. Гурвалжны медианууд огтлолцлын цэгээрээ оройгоосоо тоолбол ямар харьцаагаар хуваагддаг вэ?", ["1:1", "1:2", "2:1", "3:1"], index=None, key="q2")
        
        q3 = st.radio("3. Гурвалжны нэг оройгоос татсан биссектрис эсрэг талаа 4 см ба 6 см хэрчмүүдэд хуваажээ. Налсан нэг тал нь 8 см бол нөгөө талын уртыг ол.", ["12 см", "10 см", "14 см", "16 см"], index=None, key="q3")
        
        q4 = st.radio("4. Тэгш өнцөгт гурвалжны катетууд 9 см ба 12 см бол гипотенузын уртыг ол.", ["13 см", "15 см", "17 см", "20 см"], index=None, key="q4")
        
        q5 = st.radio("5. Тойргийн төвөөс хөвчид буусан перпендикуляр нь уг хөвчийг хэрхэн хуваадаг вэ?", ["2:1 харьцаагаар", "Хагаслан хуваана", "Гурав хуваана", "Хуваахгүй"], index=None, key="q5")
        
        q6 = st.radio("6. Тойрогт багтсан өнцөг 40° бол түүнд тулсан нумын хэмжээг ол.", ["20°", "40°", "80°", "160°"], index=None, key="q6")
        
        q7 = st.radio("7. △ABC-ийн ∠C=90°, AC=12 см, tanA=3/4 бол BC катетын уртыг ол.", ["8 см", "9 см", "10 см", "16 см"], index=None, key="q7")
        
        q8 = st.radio("8. Адил хажуут гурвалжны суурь 16 см, хажуу тал 10 см бол суурьт буусан өндрийг ол.", ["6 см", "8 см", "12 см", "5 см"], index=None, key="q8")
        
        q9 = st.radio("9. Тойргийн радиус 13 см. Тойргийн төвөөс 5 см зайд орших хөвчийн уртыг ол.", ["12 см", "24 см", "26 см", "10 см"], index=None, key="q9")
        
        q10 = st.radio("10. Тойргийн огтлолцсон хоёр хөвчийн нэг нь 4 см ба 9 см хэрчмүүдэд хуваагджээ. Нөгөө хөвчийн нэг хэсэг нь 6 см бол үлдсэн хэсгийг ол.", ["4 см", "5 см", "6 см", "8 см"], index=None, key="q10")
        
        q11 = st.radio("11. Тойргийн гадна цэгээс татсан шүргэгч 12 см, огтлогчийн гадна хэсэг 8 см бол огтлогчийн нийт уртыг ол.", ["15 см", "16 см", "18 см", "20 см"], index=None, key="q11")
        
        q12 = st.radio("12. Тойргийн гадна оройтой өнцгийн хашиж буй их нум 110°, бага нум 30° бол уг өнцгийн хэмжээг ол.", ["80°", "140°", "40°", "70°"], index=None, key="q12")

        st.write("---")
        st.write("### II ХЭСЭГ. НӨХӨХ ДААЛГАВАР")
        
        # 13-р асуулт
        st.write("13. Тойргийн радиус 15 см, төвөөс хөвч хүртэлх зай 9 см.")
        st.latex(r"x = \sqrt{15^2 - 9^2}")
        q13 = st.text_input("Хөвчийг хагаслан хуваах хэрчмийн урт x хэд вэ?", key="q13")
        
        # 14-р асуулт
        st.write("14. Гэрийн хана 150 см, тооно 230 см. Өндрийн зөрүүг (катет) олоорой.")
        st.latex(r"h = 230 - 150")
        q14 = st.text_input("Унины катет h хэд вэ?", key="q14")
        
        # 15-р асуулт
        st.write("15. Их нум 130°, бага нум 50° бол харах өнцгийг олоорой.")
        st.latex(r"\angle A = \frac{130^\circ - 50^\circ}{2}")
        q15 = st.text_input("Өнцгийн хэмжээ хэд вэ?", key="q15")
