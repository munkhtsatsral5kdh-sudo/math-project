    ...
    with col2:
        st.markdown(f"""
            <div class="goal-box">
                ...
                ">
                    Сонирхолтой цахим хичээл, баялаг бодлогын сангаар дамжуулан мэдлэгээ 
                    бие даан ахиулж,ирээдүйн амжилтынхаа суурийг өнөөдөр тавиарай. 
                    Хамтдаа суралцаж хамтдаа хөгжицгөөе!
                </div>
            </div>
        """, unsafe_allow_html=True)
